...
const faqs = [
  ...
  {
    q: "What's the difference between Basic, Premium, and Exclusive licenses?",
    a: "Basic (₦30,000) gives you WAV files for non-exclusive use up to 10,000 streams. Premium (₦70,000) adds stems and unlimited streams. Exclusive (₦150,000) gives you full ownership — the beat is removed from the store permanently.",
  },
  {
    q: "Can someone else buy the same beat I licensed?",
    a: "Yes, for Basic and Premium licenses. Multiple artists can license the same beat non-exclusively. Only the Exclusive license removes the beat from the store.",
  },
  {
    q: "What happens after I pay?",
    a: "You'll receive an email with your download links and license agreement within minutes. Links expire in 7 days so download promptly.",
  },
  {
    q: "Can I get a refund?",
    a: "Due to the digital nature of music files, all sales are final. If you have an issue with your purchase, contact us at kingpsalmyofficial@gmail.com.",
  },
  {
  ...
  },
  {
    ...
    a: "Basic and Premium licenses cover non-commercial and commercial use within their stream limits. Exclusive licenses cover unlimited commercial use.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Contact the producer directly at kingpsalmyofficial@gmail.com to discuss custom projects and collaborations.",
  },
  {
    q: "What file formats do I receive?",
    a: "Basic: WAV. Premium: WAV + full stems (trackouts). Exclusive: WAV + stems + direct producer access for any modifications.",
  },
]
