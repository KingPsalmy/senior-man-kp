...
const navItems = [
  ...
  { icon: "📀", label: "Sold Beats", href: "/admin/dashboard/sold-beats", active: false },
    ...
    <main style={{ minHeight: "100vh", backgroundColor: "var(--bg-void)", display: "flex" }}>
      ...
      <div className="admin-main" style={{ marginLeft: "220px", flex: 1, padding: "32px", minWidth: 0 }}>
        ...
        <div className="admin-mobile-header" style={{
          ...
          <span className="admin-mobile-title" style={{ color: "var(--text-primary)", fontWeight: 800, fontFamily: "var(--font-ui)", fontSize: "1.3rem" }}>Dashboard</span>
        ...
        <div className="admin-stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px", marginBottom: "8px" }}>
          {loadingStats ? (
            ...
            [
              ...
              <div key={stat.label} className="admin-stat-card" style={{ backgroundColor: "var(--bg-card)", border: "1px solid var(--border-subtle)", borderRadius: "8px", padding: "22px" }}>
                <div className="admin-stat-label" style={{ color: "var(--text-muted)", fontSize: "0.78rem", fontFamily: "var(--font-mono)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "10px" }}>
                  {stat.label}
                </div>
                <div className="admin-stat-value" style={{ color: "var(--text-primary)", fontSize: "1.9rem", fontWeight: 800, fontFamily: "var(--font-ui)", letterSpacing: "-0.02em" }}>
                  {stat.value}
                </div>
              </div>
            ))
        ...
        <div style={{ backgroundColor: "var(--bg-card)", border: "1px solid var(--border-subtle)", borderRadius: "8px", overflow: "hidden" }}>
          <div className="admin-section-header" style={{ padding: "20px 24px", borderBottom: "1px solid var(--border-subtle)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <Link href="/admin/dashboard/purchases" className="admin-view-all" style={{ color: "var(--gold)", fontSize: "0.85rem", fontFamily: "var(--font-ui)", textDecoration: "none" }}>
              View all →
            </Link>
          </div>

          {loadingStats ? (
            <div style={{ padding: "40px", textAlign: "center", color: "var(--text-muted)", fontFamily: "var(--font-mono)", fontSize: "0.9rem" }}>
              Loading orders...
            </div>
          ) : recentOrders.length === 0 ? (
            <div style={{ padding: "60px", textAlign: "center" }}>
              <p style={{ color: "var(--text-muted)", fontFamily: "var(--font-ui)", fontSize: "0.95rem" }}>No orders yet.</p>
            </div>
          ) : (
            <>
